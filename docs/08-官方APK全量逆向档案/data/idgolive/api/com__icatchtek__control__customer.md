# idGoLive — 类与成员明细：com.icatchtek.control.customer
...
方法（15）：
- `boolean addEventListener(int i, ICatchCameraListener iCatchCameraListener)`  L19
- `boolean addEventListener(int i, ICatchCameraListener iCatchCameraListener, boolean z)`  L23
- `boolean delEventListener(int i, ICatchCameraListener iCatchCameraListener)`  L27
- `boolean delEventListener(int i, ICatchCameraListener iCatchCameraListener, boolean z)`  L31
- `boolean deviceInit(String str)`  L35
- `boolean loadLibrary(Context context, String str, String str2)`  L37
- `void notifyUpdateFw()`  L39
- `String simpleConfig(Context context, String str, String str2, String str3, String str4)`  L41
- `String simpleConfig(Context context, String str, String str2, String str3, String str4, int i)`  L43
- `String simpleConfig(Context context, String str, String str2, byte[] bArr, String str3, String str4, int i)`  L45
- `boolean simpleConfigCancel()`  L47
- `boolean startDeviceScan()`  L49
- `boolean stopDeviceScan()`  L51
- `boolean updateFw(ICatchCameraSession iCatchCameraSession, String str)`  L53
- `boolean wakeUpCamera(String str)`  L55
...
- `void logI(String str, String str2)`  L17
- `void setDebugMode(boolean z)`  L21
- `void setFileLogOutput(boolean z)`  L25
- `void setFileLogPath(String str)`  L29
- `void setLog(int i, boolean z)`  L33
- `void setLogLevel(int i, int i2)`  L37
- `void setSystemLogOutput(boolean z)`  L41
...
- `boolean checkConnection()`  L46
- `boolean destroySession()`  L51
- `ICatchCameraControl getControlClient()`  L59
- `ICatchCameraInfo getInfoClient()`  L64
- `ICatchCameraPlayback getPlaybackClient()`  L69
- `ICatchCameraProperty getPropertyClient()`  L74
...
- `int getDataSize()`  L16
- `byte[] getValue()`  L20
- `void setValue(byte[] bArr, int i)`  L24
...
方法（25）：
- `double getDoubleValue1()`  L20
- `double getDoubleValue2()`  L24
- `double getDoubleValue3()`  L28
- `int getEventID()`  L32
- `ICatchFile getFileValue1()`  L36
- `int getIntValue1()`  L40
- `int getIntValue2()`  L44
- `int getIntValue3()`  L48
- `int getSessionID()`  L52
- `String getStringValue1()`  L56
- `String getStringValue2()`  L60
- `String getStringValue3()`  L64
- `void setDoubleValue1(double d)`  L68
- `void setDoubleValue2(double d)`  L72
- `void setDoubleValue3(double d)`  L76
- `void setEventID(int i)`  L80
- `void setFileValue1(ICatchFile iCatchFile)`  L84
- `void setIntValue1(int i)`  L88
- `void setIntValue2(int i)`  L92
- `void setIntValue3(int i)`  L96
- `void setSessionID(int i)`  L100
- `void setStringValue1(String str)`  L104
- `void setStringValue2(String str)`  L108
- `void setStringValue3(String str)`  L112
...
- `int getFrameHeight()`  L13
- `int getFrameWidth()`  L17
- `void setFrameHeight(int i)`  L21
- `void setFrameWidth(int i)`  L25
...
L14 · [class] public ICatchCamPhotoExif · `com/icatchtek/control/customer/type/ICatchCamPhotoExif.java`

字段/常量（37）：
- `int ORIENTATION_FLIP_HORIZONTAL = 2`  L15
- `int ORIENTATION_FLIP_VERTICAL = 4`  L16
- `int ORIENTATION_NORMAL = 1`  L17
- `int ORIENTATION_ROTATE_180 = 3`  L18
- `int ORIENTATION_ROTATE_270 = 8`  L19
- `int ORIENTATION_ROTATE_90 = 6`  L20
- `int ORIENTATION_TRANSPOSE = 5`  L21
- `int ORIENTATION_TRANSVERSE = 7`  L22
- `int ORIENTATION_UNDEFINED = 0`  L23
- `String TAG_APERTURE = "FNumber"`  L24
- `String TAG_DATETIME = "DateTime"`  L25
- `String TAG_EXPOSURE_TIME = "ExposureTime"`  L26
- `String TAG_FLASH = "Flash"`  L27
- `String TAG_FOCAL_LENGTH = "FocalLength"`  L28
- `String TAG_GPS_ALTITUDE = "GPSAltitude"`  L29
- `String TAG_GPS_ALTITUDE_REF = "GPSAltitudeRef"`  L30
- `String TAG_GPS_DATESTAMP = "GPSDateStamp"`  L31
- `String TAG_GPS_LATITUDE = "GPSLatitude"`  L32
- `String TAG_GPS_LATITUDE_REF = "GPSLatitudeRef"`  L33
- `String TAG_GPS_LONGITUDE = "GPSLongitude"`  L34
- `String TAG_GPS_LONGITUDE_REF = "GPSLongitudeRef"`  L35
- `String TAG_GPS_PROCESSING_METHOD = "GPSProcessingMethod"`  L36
- `String TAG_GPS_TIMESTAMP = "GPSTimeStamp"`  L37
- `String TAG_IMAGE_LENGTH = "ImageLength"`  L38
- `String TAG_IMAGE_WIDTH = "ImageWidth"`  L39
- `String TAG_ISO = "ISOSpeedRatings"`  L40
- `String TAG_MAKE = "Make"`  L41
- `String TAG_MODEL = "Model"`  L42
- `String TAG_ORIENTATION = "Orientation"`  L43
- `String TAG_WHITE_BALANCE = "WhiteBalance"`  L44
- `int WHITEBALANCE_AUTO = 0`  L45
- `int WHITEBALANCE_MANUAL = 1`  L46
- `SimpleDateFormat sFormatter`  L47
- `HashMap<String, String> mAttributes`  L48
- `boolean mHasThumbnail`  L49
...
- `String getAttribute(String str)`  L103
- `double getAttributeDouble(String str, double d)`  L107
- `int getAttributeInt(String str, int i)`  L124
- `long getDateTime()`  L136
    - 体内字面量："DateTime"
- `long getGpsDateTime()`  L152
    - 体内字面量："GPSDateStamp" · "GPSTimeStamp" · " "
- `boolean getLatLong(float[] fArr)`  L168
    - 体内字面量："GPSLatitude" · "GPSLatitudeRef" · "GPSLongitude" · "GPSLongitudeRef"
- `boolean hasThumbnail()`  L184
- `void setAttribute(String str, String str2)`  L188
...
方法（16）：
- `ICatchCamVideoRecordStatus fromString(String str)`  L16
    - 体内字面量："cardStatus" · "years" · "months" · "days" · "hours" · "minutes" · "seconds"
- `int getCardStatus()`  L41
- `int getDays()`  L45
- `int getHours()`  L49
- `int getMinutes()`  L53
- `int getMonths()`  L57
- `int getSeconds()`  L61
- `int getYears()`  L65
- `void setCardStatus(int i)`  L69
- `void setDays(int i)`  L73
- `void setHours(int i)`  L77
- `void setMinutes(int i)`  L81
- `void setMonths(int i)`  L85
- `void setSeconds(int i)`  L89
- `void setYears(int i)`  L93
- `String toString()`  L97
    - 体内字面量："cardStatus" · "years" · "months" · "days" · "hours" · "minutes" · "seconds"
